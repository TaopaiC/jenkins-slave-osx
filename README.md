...
## Quick Start
`bash <( curl -L https://raw.githubusercontent.com/TaopaiC/jenkins-slave-osx/master/install.sh )`
...
## Install
`bash <( curl -L https://raw.githubusercontent.com/TaopaiC/jenkins-slave-osx/master/install.sh ) [options]`
